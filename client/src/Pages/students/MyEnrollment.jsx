  ...
  return (
    ...
    <div className='md:px-36 px-8 pt-10'>
      ...
      <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
        ...
        max-sm:hidden'>
          <tr>
            <th className='px-4 py-3 semibold truncate'>Course</th>
            <th className='px-4 py-3 semibold truncate'>Duration</th>
            <th className='px-4 py-3 semibold truncate'>Completed</th>
            <th className='px-4 py-3 semibold truncate'>Status</th>
          </tr>
        </thead>
