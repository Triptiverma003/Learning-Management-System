  ...
  return courseData ?(
    ...
    {/* Course Review and rating */}
     <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
              ...
              <p className='text-sm'>Course by <span className='text-blue-600 underline'>Tripti</span></p>
     ...
     {/*Right column*/}
    <div className='max-w-course z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden
        ...
        <div className='flex items-center text-sm md:text-default gap-4 pt-2  md:pt-4 text-gray-500'>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                <li>Lifetime access with a free updates.</li>
